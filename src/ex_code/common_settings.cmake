...
elseif (${HOSTNAME} STREQUAL  "yerrick-M14xR2")
  message(STATUS "yl's machine")
  message(STATUS "Using yl optimisation options")
  ...
  set(local_CUDA_CUT_INCLUDE_DIRS "/usr/local/cuda-5.0/samples/common/inc")
  #yl set(local_CUDA_CUT_LIBRARY_DIRS "/home/rodrigob/code/references/cuda/cuda_sdk/C/lib")
  ...
  set(liblinear_INCLUDE_DIRS "/usr/include")
  set(liblinear_LIBRARY_DIRS "/usr/lib")
